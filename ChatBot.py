...
label1 = tk.Label(master=frame1, text="Universidad Metropolitana de Monterrey", 
...
B = tk.Button(master=frame1, text ="Iniciar",height= 5,
               width=50, bg='white',fg='red',
                 command=partial(lti.TextToVoice, text))
B.place(x=450, y=113)

B2 = tk.Button(master=frame1, text ="Preguntale a Leo",height= 5,
                width=50, bg='white',fg='red', command=lti.pregunta)
